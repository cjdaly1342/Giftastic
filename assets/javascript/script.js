// Variables needed to run the script for this page
var subject;  // 
var limit = '&limit=12';
...
function displayButtons() {
	for(j = 0; j < bands.length; j++) {
		showButtons = $('<div class="col col-xs-2 col-btn"><button class="btn btn-default btn-gif" data-subject="' + bands[j] + '"><span>' + bands[j] + '</span></button></div>');
